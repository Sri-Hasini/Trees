# Leaf under budget
- [GeeksforGeeks](https://www.geeksforgeeks.org/problems/leaf-under-budget/1?page=1&category=Tree&difficulty=Basic,Easy&status=unsolved&sortBy=submissions)
## Code in cpp:
```cpp
//{ Driver Code Starts
