...
- [GeeksforGeeks](https://www.geeksforgeeks.org/problems/level-of-a-node-in-binary-tree/1?page=2&category=Tree&difficulty=Basic,Easy&status=unsolved&sortBy=submissions)
## Code in cpp:
```cpp
//{ Driver Code Starts
#include <bits/stdc++.h>
